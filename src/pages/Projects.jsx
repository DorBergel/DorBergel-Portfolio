          ...
          <Col sm={12} md={12}>
            <div className="project-extended">
              <div className="project-header">
                ...
                <p>
                  Extended description of the project, including technologies
              ...
              <div className="project-content">
                <div className="project-objective">
                  <h3>Objective</h3>
                  <p>
                    Explain the main goal of the project and what it aims to
                    achieve.
                  </p>
                </div>
                ...
                <div className="impact-and-future-work">
                  ...
                  <p>
                    Discuss the impact of the project and any future work
                    planned.
                  </p>
                </div>
              </div>
